...
#==============================================================================
    ...
    def CreateSeqs(self,distances=[],WTs=[]):
...
#==============================================================================  
    ...
    def TrainModels(self,protein=[]):
        #check if the input 'protein' is a list of proteins and train all the
        #models needed, if protein is not specified then all three models will
        #be trained.
...
#==============================================================================  
    def Predict(self):
        ...
        #create a folder that will contatin all predictions.
